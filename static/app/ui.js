...
* ------v------*/
    ...
    addSettingsHandlers() {
        ...
        UI.addSettingChangeHandler('device_id');
 ...
 * ------v------*/
    ...
    connect(event, password) {
        ...
        const port = 80;
        const path = 'ws';
        const device_id = UI.getSetting('device_id')
